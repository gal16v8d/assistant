...
def open_webpage_crypto_args(**kwargs: dict[str, Any]) -> str:
    """
    Opens a webpage based on the user's input.
    """
    webpage_crypto_name = get_user_input(
        request_value_t=const.TEXT_CRYPTO_MSG,
        request_value_v=const.VOICE_CRYPTO_MSG,
        error_msg=const.NO_CRYPTO_MSG,
        **kwargs,
    )
